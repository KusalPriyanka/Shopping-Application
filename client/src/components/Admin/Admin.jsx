    ...
    return (
        <div className={classes.root}>
            <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}  >
                <Toolbar className={classes.toolbar}>
                    ...
                    <Typography component="h1" variant="h6" color="inherit" noWrap className={classes.title}>
                        ...
                        {storeManager ? "Store Manager": null}
            ...
            >
                ...
                <Divider />
                <ListItem button={true} {...{ onClick: handleDashboard }}>
                    <ListItemIcon>
                        <DashboardIcon />
                    </ListItemIcon>
                    <ListItemText primary="Dashboard" />
                </ListItem>
                <ListItem button={true} {...{ onClick: handleStoreManager }}>
                    <ListItemIcon>
                        <PeopleIcon />
                    </ListItemIcon>
                    <ListItemText primary="Store managers" />
                </ListItem>
                <ListItem button={true} {...{ onClick: handleCategories }}>
                    <ListItemIcon>
                        <LayersIcon />
                    </ListItemIcon>
